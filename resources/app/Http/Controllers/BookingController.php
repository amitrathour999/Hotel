...
class BookingController extends Controller
{
    ...
    public function bookingcode(Request $request)
    {
        ...
        $bookingStatus = $isOnlinePayment ? 'confirmed' : 'pending';
        ...
        $msg = $isOnlinePayment 
            ? 'Booking & Payment Successful! Your room reservation has been confirmed.'
            : 'Booking Created Successfully! Payment is pending (Pay at Hotel).';
    ...
    {
        $booking = Booking::with(['room', 'payment'])->get();
    ...
    {
        $user_id = session('user_id');
        $booking = Booking::with(['room', 'payment'])->where('user_id', $user_id)->latest()->get();
